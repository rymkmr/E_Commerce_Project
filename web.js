...
function displayCart() {
    ...
    if (cart.length === 0) {
        ...
        subtotalE1.textContent = "0 DZD";
        grandTotalE1.textContent = "0 DZD";
        return;
    }
let subtotal=0;
cart.forEach((item, index) => {
    ...
    cartItem.innerHTML = `
        ...
        <span class="total-price">${itemTotal} DZD</span>
...
subtotalE1.textContent=`${subtotal.toFixed(2)}DZA`;
grandTotalE1.textContent=`${subtotal.toFixed(2)}DZA`;
 removeCartItem();
 updateCartQuantity();
}
